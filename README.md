...
```bash
wget https://github.com/Alonza0314/it-system/releases/download/v0.0.9/it-system-controller_0.0.9_amd64.deb
sudo dpkg -i it-system-controller_0.0.9_amd64.deb
```
...
```bash
wget https://github.com/Alonza0314/it-system/releases/download/v0.0.9/it-system-runner_0.0.9_amd64.deb
sudo dpkg -i it-system-runner_0.0.9_amd64.deb
```
