...
```bash
wget https://github.com/Alonza0314/it-system/releases/download/v0.1.1/it-system-controller_0.1.1_amd64.deb
sudo dpkg -i it-system-controller_0.1.1_amd64.deb
```
...
```bash
wget https://github.com/Alonza0314/it-system/releases/download/v0.1.1/it-system-runner_0.1.1_amd64.deb
sudo dpkg -i it-system-runner_0.1.1_amd64.deb
```
