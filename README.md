...
```bash
wget https://github.com/Alonza0314/it-system/releases/download/v0.0.0/it-system-controller_0.0.2_amd64.deb
...
```bash
wget https://github.com/Alonza0314/it-system/releases/download/v0.0.0/it-system-runner_0.0.2_amd64.deb
